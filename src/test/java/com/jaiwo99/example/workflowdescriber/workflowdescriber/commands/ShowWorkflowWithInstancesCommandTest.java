...
public class ShowWorkflowWithInstancesCommandTest {

    @InjectMocks
    private ShowWorkflowWithInstancesCommand instance;
    @Mock
    private DataAggregator dataAggregator;

    @Test
    public void execute_should_match_command() {
        final boolean result = instance.execute(new String[]{ShowWorkflowWithInstancesCommand.COMMAND});
